...
public class Functions {
	...
	public static int getLowestWorldID(ArrayList<GravityWorld> worlds) {
		ArrayList<Integer> usedNumbers = new ArrayList<Integer>();
		for (GravityWorld world : worlds) {
	...
	public static GravityWorld getWorldByID(ArrayList<GravityWorld> worlds, int id) {
		GravityWorld w = null;
		for (GravityWorld world : worlds) {
			if (world.id == id) {
				w = world;
	...
	public static GravityWorld getWorldByWorld(ArrayList<GravityWorld> worlds, World world1) {
		GravityWorld w = null;
		for (GravityWorld world : worlds) {
