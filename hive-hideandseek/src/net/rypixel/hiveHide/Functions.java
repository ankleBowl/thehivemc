...
public class Functions {
	...
	public static int getLowestWorldID(ArrayList<HideWorld> worlds) {
	...
	public static HideWorld getWorldByID(ArrayList<HideWorld> worlds, int id) {
		HideWorld w = null;
		for (HideWorld world : worlds) {
			if (world.id == id) {
				w = world;
	...
	public static HideWorld getWorldByWorld(ArrayList<HideWorld> worlds, World world1) {
		HideWorld w = null;
		for (HideWorld world : worlds) {
